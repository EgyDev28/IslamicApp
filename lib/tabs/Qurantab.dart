        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Divider(color: AppTheme.gold,height: 25,thickness: 2),
              IntrinsicHeight(
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Text('اسم السورة',textAlign: TextAlign.center,style: TextStyle(
                          color:
                    ...
                    VerticalDivider(color: AppTheme.gold,thickness: 2,),
                    Expanded(
                      child: Text('عدد الايات',textAlign: TextAlign.center,style: TextStyle(
                          color:
                          Provider.of<SettingProvider>(context).isDark
                              ? AppTheme.gold
                              : AppTheme.black,
                            ...
                            onTap: () {
                              Navigator.of(_).pushNamed(
                                ...
                                arguments: SuraArgument(
                                    index: index, SuraName: Soura[index]),
                              );
                            },
                          ),
                        ),
